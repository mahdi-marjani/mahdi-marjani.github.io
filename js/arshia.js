/*-----------------------------------------------------------
 * Template Name    : Bootstrap 5 Responsive Personal V-Card Resume HTML Template
            ...
            $(this).magnificPopup({
                ...
                callbacks: {
                    markupParse: function() {
                        let videoUrl = 'videos/video' + this.index + '.mp4';
                        ...
                        let observer = new MutationObserver(function(mutations) {
                            ...
                            mutation.addedNodes.forEach(function(addedNode) {
                                if (addedNode.nodeName) {
                                    try {
                                        let added_element = addedNode.childNodes[0];
                                    if (added_element.childNodes[0].childNodes[0].childNodes[1].nodeName == 'IFRAME' && added_element.childNodes[0].childNodes[0].childNodes[1].classList[0] == 'mfp-iframe') {
                                        let iframe = added_element.childNodes[0].childNodes[0].childNodes[1];
                                        let video = document.createElement('video');
                                        video.src = videoUrl;
                                        video.classList.add('mfp-iframe')
